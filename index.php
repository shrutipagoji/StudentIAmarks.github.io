<html>
<head>
    <title>Student Internal Marks Assessment System</title>
      ...
      <nav>
        <div class="row clearfix">
            <ul class="main-nav" animate slideInDown>
                ...
                <li><a href="admin/email.php">MAIL US</a></li>
                <li><a href="admin/timetable.php"><b> TIME TABLE</b></a></li>
          </ul>
        </div>
      </nav>
      <div class="main-content-header">
        <form method="post" action="result.php">
          <table class="table">
            ...
            <tr>
                <th class="sem1">Semester</th>
                <td class="sem2"><input type="text" name="sem" required class="box2"/></td>
            </tr> 
            <tr>
